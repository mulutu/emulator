<?php
/*
require_once "../_configs/bossConfigs.php";
require_once "../_configs/coreUtils.php";
include 'IOUtils.php';
$dbname="ussd";
...
//              if (mysql_num_rows($gfQuery)>0)
                 ...
                 if ($opCode !="BEG")//we have an existing session
      ...
      if($mNumber=="" or $data=="" or $sessionID=="")
        ...
        {
        global $sessionID, $mNumber, $data, $shortCode, $abort, $message, $filePathDir, $fileNamePart, $fileName, $ussdArray, $type, $currentLevel, $tempLevel,  $filePath, $sessionFileName, $sessionFileID, $flogPath, $db_link, $myRand2,$networkID;
...
flog($flogPath, "$mNumber | tempLevelSQL = $tempLevelSQL");
        ...
        function abort($mobileNo)
        {
                        ...
                        if($filePath=="")
                        {
                                ...
                                flog($flogPath, "$mNumber | invoking  abort for MSISDN: $mobileNo and filePath = $filePath and sessionID = '$sessionID'");
